...
namespace HotelierProject.WebUI.Controllers
{
    public class AdminMailController : Controller
    {
        ...
        public IActionResult Index(AdminMailViewModel adminMailViewModel)
        {
            ...
            MailboxAddress mailboxAddressFrom = new MailboxAddress("HotelierAdmin","projemailapi@gmail.com");
            ...
            bodyBuilder.TextBody = adminMailViewModel.Content;
            ...
            client.Authenticate("projemailapi@gmail.com", "xttyyzftmplfwzqk");
